...
Например, в некоторых проектах, где я работал, жирным в текстах могли быть выделены самые разные фрагменты, в том числе смысловые: "**очень** сильно", "**только** в этом случае".
...
Я заметил, что некоторые коммерческие названия у вас не выделены никак.
